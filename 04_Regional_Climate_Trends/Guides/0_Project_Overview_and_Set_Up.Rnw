...
\date{\today~(ver. 0.73)} % without \date command, current date is supplied
...
\begin{figure}
  ...
  \includegraphics[width=1.4\textwidth]{figure/flow-chart.pdf}
\end{figure}
...
Select State    &     x (y) & Rstudio, R code and NOAA website & Guide 1 \\ \hline
Download Station Data & x (y) & Rstudio, R code and NOAA website & Guide 1  \\ \hline
Read Station Data into R & 5 (y) & Rstudio, R code & Guide 1 \\ \hline
Fix Dates & x (y) & Rstudio, R code &  \\ Guide 2 \\ \hline
Transform Data & x (y) & Rstudio, R code &  Guide 2 \\ \hline
Subset for TMAX & x (y) & Rstudio, R code & Guide 3 \\ \hline
Linear Model for TMAX & x (y) & Rstudio, R code & Guide 3 \\ \hline
Evaluation of Model & x (y) & Rstudio, R code & Guide 3 \\ \hline
Subset for TMIN & x (y) & Rstudio, R code & Guide 3 \\ \hline
Linear Model for TMIN & x (y) & Rstudio, R code & Guide 3 \\ \hline
Evaluation of Model & x (y) & Rstudio, R code & Guide 3 \\ \hline
Subset for PRCP & ? (y) & Rstudio, R code & Guide 3 \\ \hline
Linear Model for PRCP & ? (y) & Rstudio, R code & Guide 3 \\ \hline
Evaluation of Model & ? (y) & Rstudio, R code & Guide 3\\ \hline
Read EPA State Impact Report & ? (y) & EPA website & Canvas Link  \\ \hline
Explore Other Analysis Options & ?0 (y) & Rstudio, R code & Guide 3 \\ \hline
Create Presentation Ready Graphics & ?0 (y) & Rstudio, R code & Guide 4 \\ \hline
Scripting for Video & ?0 (y) & Rstudio, R code & Guide 4 \\ \hline
Make Video & ?0 (y) & Rstudio, R code & Guide 4 \\ \hline
Upload Video & ? (y) & Rstudio, R code & Guide 4 \\ \hline
\end{tabular}
\end{table}
