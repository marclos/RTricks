...
\begin{enumerate}
  ...
  \item Evaluate distirbution changes by decade / score
  \item Evaluate extreme events
\end{enumerate}

\section{Functions to Analyze Monthly Trends}

<<setup, echo=FALSE, results='hide', message=FALSE>>=
datafolder = "/home/mwl04747/RTricks/04_Regional_Climate_Trends/Data/SP24/"
library(xtable)
library(here)
source(here("04_Regional_Climate_Trends", "Guides", "Guide3.R"))
@

\subsection{Before Starting the Process}

Before you begin, make sure you have the stations to read into R. Loot at the R eneivornment to see that the stations have been loaded in to R. If not, please Slack Marc and mentors, so we help you get these files into the R environment, which might mean running the previous guide again. 

\subsection{R Code with Custom Functions}

Run the \href{https://github.com/marclos/RTricks/blob/master/04_Regional_Climate_Trends/Guides/Guide3.R}{Guide3.R} code and the functions will be loaded into your environment automatically.

As we get futhrer into the project, these code chunks may require tweaking because of the questions you are interested in your location. Marc and the mentors will help you with this.
...
\subsection{Reading csv and loading R.data}

\begin{description}

  \item[Read and Load Data] This function will read the csv files and load the data into R. The function will also return a list of dataframes.
...
\subsection{Function to Evaluate Trends by Month}
...
\item[Example of how to use the function]

<<echo=TRUE, results='hide'>>=
USC00042294.trends <- monthlyTrend.fun(USC00042294.anomalies)
@

\item[Explore Results] bwzr

Table %~\ref{tab:TMAXtrends} 
...
xtable(USC00042294.trends[USC00042294.trends$ELEMENT=="TMAX",],
       caption="TMAX Trends")
# print command?
...
\subsubsection{Example of Loop Code from Provious Interation}
...
<<estDensity, warning=FALSE, results='hide', eval=FALSE>>=
...
<<animated_normalPDFs, results='hide', eval=FALSE>>=
...
<<animate, results='hide', eval=FALSE>>=
