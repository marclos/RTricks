...
\title{Guide 3: Analyzing Climate Trends}
...
plot(TMIN.a ~ Ymd, data=subset(USC00042294.anamolies$TMIN, 
  ...
  subtitle <- c("Trend Line: 2.0/100 yrs; 
                p-value = 0.004, r2 = 0.006")
...
I have created a basic function template, but we'll develop this together when we have a chance.. 
...
station = subset(USC00040693.anamolies$PRCP)
