...
stations.active.oldest = read.csv(here("04_Regional_Climate_Trends", "stations.active.oldest.csv"))
@ 
...
plot(VALUE ~ YEAR, data = subset(station1.monthly, MONTH == 1), 
     las=1, pch=19, col = "blue", cex=.5)
