...
\begin{itemize}
  \item \verb|station1.anomolies[[1]]| for TMAX
  \item \verb|station1.anomolies[[2]]| for TMIN
  \item \verb|station1.anomolies[[3]]| for PRCP
\end{itemize}
...
plot(TMAX.a ~ Ymd, data=station1.anomolies[[1]], type="p", col="red", pch=19, cex=.2, las=1, xlab="Year", ylab="Temperature Anomaly (C)", main="Monthly Maximum Temperature Change")
plot(TMIN.a ~ Ymd, data=station1.anomolies[[2]], type="p", col="blue", pch=19, cex=.2, las=1, xlab="Year", ylab="Temperature Anomaly (C)", main="Monthly Minimum Temperature Change")
plot(PRCP.a ~ Ymd, data=station1.anomolies[[3]], type="p", col="green", pch=19, cex=.2, las=1, xlab="Year", ylab="Precipitation Anomaly (C)", main="Monthly Precipiation Change")
@
\end{figure}
