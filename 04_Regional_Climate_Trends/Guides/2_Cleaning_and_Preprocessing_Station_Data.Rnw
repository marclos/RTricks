...
<<echo=TRUE, results='hide'>>=
USC00042294.anamolies <- 
  MonthlyAnamolies.fun(USC00042294.monthly, USC00042294.normals)
USC00040693.anamolies <- 
  MonthlyAnamolies.fun(USC00040693.monthly, USC00040693.normals)
@
...
\begin{itemize}
  \item \verb|USC00042294.anamolies[[1]]| for TMAX
  \item \verb|USC00042294.anamolies[[2]]| for TMIN
  \item \verb|USC00042294.anamolies[[3]]| for PRCP
\end{itemize}
...
plot(TMAX.a ~ Ymd, data=USC00042294.anamolies[[1]], type="p", col="red", pch=19, cex=.2, las=1, xlab="Year", ylab="Temperature Anamoly (C)", main="Monthly Maximum Temperature Change")
plot(TMIN.a ~ Ymd, data=USC00042294.anamolies[[2]], type="p", col="blue", pch=19, cex=.2, las=1, xlab="Year", ylab="Temperature Anamoly (C)", main="Monthly Minimum Temperature Change")
plot(PRCP.a ~ Ymd, data=USC00042294.anamolies[[3]], type="p", col="green", pch=19, cex=.2, las=1, xlab="Year", ylab="Precipitation Anamoly (C)", main="Monthly Precipiation Change")
@
\end{figure}



\Large\textcolor{Magenta}{Your are done with this guide, now take a break, a walk, and enjoy some screen free downtime. Next, go to Guide 3!}
...
For now, I am just saving the anamolies data into an RData file that I can use in other Rmd Guides. I doubt you'll need to do that.
...
\subsection{MonthlyAnamolies.fun}

Here's the function: 

<<echo=FALSE>>=
print(MonthlyAamolies.fun)
@
