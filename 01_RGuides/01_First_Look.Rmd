---
title: "Introducing R"
runningheader: "Introducing R" # only for pdf output
subtitle: "R: First Look" # only for html output
...
This is a short handout to give you a first glimse at an open source programming
environment, call R. The program is extremely powerful and probably the most 
taught statistical analysis program for graduate students in the world. 

Plus, it's free!

## Using Rstudio

We will use Rstudio Server, which is made avaialable to all students enrolled at 
Pomona College. 

Before you start this tutorial, please go to Pomona's ITS office and request a
computer account. They will give you a login and password. Please don't lose the 
password.

Once you have the password, you can open Rstudio Server, by typing in the following 
address in your favorite browser: [Rstudio.pomona.edu](https://rstudio.pomona.edu).


## R Studio -- Four Window and Lots of Tabs

Once you login, you see something like this: 
...
knitr::include_graphics("/home/mwl04747/RTricks/01_RGuides/Figures/OpeningScreenShot.pdf")
```

Please follow along in the my video to give you a basic understanding of how these 
windows are used -- it will save you lots of frustation later!
