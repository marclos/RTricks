...
- If p < α, reject the null hypothesis and conclude that the means are significantly different.

- If p ≥ α, fail to reject the null hypothesis and conclude that there is no significant difference between the means.
