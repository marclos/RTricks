...
library(xtable)
filename = "/home/mwl04747/RTricks/00_Admin/Random_IDs/EA30F2025.csv"
...
print(xtable(enrolled[,c(1, 3:7)], caption='Random Numbers for EA30, Fall 2025', label='tbl:numbers'), scalebox=1.0, caption.placement = "top")
@
