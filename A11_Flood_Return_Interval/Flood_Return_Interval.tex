...
\hlstd{mysite} \hlkwb{<-} \hlstr{"10126000"}
...
## 1      USGS 10126000 1950-04-23    5920   13.36
## 2      USGS 10126000 1951-02-11    7180   14.83
## 3      USGS 10126000 1952-05-03    7200   14.69
## 4      USGS 10126000 1953-06-11    3510    9.97
## 5      USGS 10126000 1954-04-16    2570    8.11
## 6      USGS 10126000 1955-04-20    2850    8.91
\end{verbatim}
\begin{alltt}
...
##  $ site_no  : chr  "10126000" "10126000" "10126000" "10126000" ...
##  $ peak_dt  : Date, format: "1950-04-23" ...
##  $ peak_va  : num  5920 7180 7200 3510 2570 2850 4130 5080 4340 3970 ...
##  $ gage_ht  : num  13.36 14.83 14.69 9.97 8.11 ...
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{par}\hlstd{(}\hlkwc{mfrow}\hlstd{=}\hlkwd{c}\hlstd{(}\hlnum{1}\hlstd{,}\hlnum{1}\hlstd{))}   \hlcom{# This resets the plotting area to one plot}
