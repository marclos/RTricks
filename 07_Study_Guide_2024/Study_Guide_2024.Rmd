...
Using the tree height vectors from Section [Q5a: Histogram of Tree Height Vector], we can put two histograms side-by-side.
...
We analyze the data matrix in Section [Q3b: Create a Matrix of PFAS Cancer Data].
...
Didn't have a chance to lecture on this... but here is the code to find the odds ratio of the model:
