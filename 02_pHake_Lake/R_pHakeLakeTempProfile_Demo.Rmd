...
We will use R to visualize our data from pHake Lake. 
...
plot(Temperature~Depth, data=temp) # plot where temperature is a fanction of depth
```
...
2. Add text that describes what the r code will be doing. Feel free to use my 
bullets and make them into sentences. If you are unsure about the code, come to
mentor session or search online for an explanation. 
