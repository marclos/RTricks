...
## 681 2015    11     2015.875  400.27
## 682 2015    12     2015.958  402.06
## 683 2016     1     2016.042  402.73
## 684 2016     2     2016.125  404.25
## 685 2016     3     2016.208  405.06
## 686 2016     4     2016.292  407.60
## 687 2016     5     2016.375  407.90
## 688 2016     6     2016.458  406.99
## 689 2016     7     2016.542  404.59
## 690 2016     8     2016.625  402.45
\end{verbatim}
\end{kframe}
\end{knitrout}
...
Okay as of \today, the average is 358.816\sidenote{How many significant figures should you report? Have I reported this correctly?  Look up the rule of rounding on the internet to confirm your response.} It will change next month when new is added to the data set to the NOAA dataset.  Now let's calculate the median and standard deviation.\sidenote{How could you remind yourself what the \texttt{na.rm} argument is doing?}
...
\begin{verbatim}
##       year          month        decimal.date     average     
##  Min.   :1959   Min.   : 1.00   Min.   :1959   Min.   :313.3  
##  1st Qu.:1975   1st Qu.: 3.50   1st Qu.:1975   1st Qu.:331.2  
##  Median :1991   Median : 6.00   Median :1991   Median :355.1  
##  Mean   :1991   Mean   : 6.49   Mean   :1991   Mean   :358.8  
##  3rd Qu.:2007   3rd Qu.: 9.00   3rd Qu.:2007   3rd Qu.:383.8  
##  Max.   :2023   Max.   :12.00   Max.   :2023   Max.   :424.0
\end{verbatim}
\end{kframe}
\end{knitrout}
