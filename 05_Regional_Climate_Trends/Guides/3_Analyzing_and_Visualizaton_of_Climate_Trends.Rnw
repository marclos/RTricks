...
\textbf{Milestone:} Selected a Month where the TMIN has the steepest slope and plotted the trend line. Submit this to \texttt{Canvas} for the week's reflection. 
...
USC00042294.lm = lm(TMAX.a ~ Ymd, 
                  data=subset(USC00042294.anomalies[[1]], subset=MONTH==6))

USC00042294.post1975 = subset(USC00042294.anomalies[[1]], subset= YEAR > 1974)
USC00042294.post1975.lm = lm(TMAX.a ~ Ymd, data=subset(USC00042294.post1975, 
                                                       subset=MONTH==6))

plot(TMAX.a ~ Ymd, data=subset(USC00042294.anomalies[[1]], 
...
points(TMAX.a ~ Ymd, data=subset(USC00042294.post1975, subset=MONTH==6), 
...
head(predict.lm(USC00042294.post1975.lm, interval="confidence"))


lines(USC00042294.post1975$Ymd, USC00042294.post1975.lm$fitted.values, 
      col="red", lwd=1.5)

abline(coef(USC00042294.post1975.lm), 
       col="red", lwd=1.5)
